 ...
 * org.springframework.data.r2dbc.core.R2dbcEntityTemplate; import
 * org.springframework.stereotype.Service; import
 * org.springframework.util.StreamUtils;
 * 
 * @Service public class DataSetupService implements CommandLineRunner {
 * 
 * @Value("classpath:/schema.sql") private Resource initSql;
 * 
 * @Autowired private R2dbcEntityTemplate entityTemplate;
 * 
 * @Override public void run(String... args) throws Exception { String query =
