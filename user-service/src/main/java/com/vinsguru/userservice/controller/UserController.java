...
public class UserController {
	...
	@PutMapping("{id}")
	public Mono<ResponseEntity<UserDto>> updateUserById(@PathVariable int id, @RequestBody Mono<UserDto> userDtoMono) {
		return this.service.updateUser(id, userDtoMono).map(ResponseEntity::ok)
